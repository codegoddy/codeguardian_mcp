# CodeGuardian MCP Visual Branding Concepts
...
### Shield-Style Badges (Copy-paste ready)
...
<!-- MCP Server -->
![MCP Server](https://img.shields.io/badge/MCP-Server-FF6B6B?style=for-the-badge&logo=server&logoColor=white)

<!-- AI Hallucination Detection -->
![AI Validation](https://img.shields.io/badge/AI-Hallucination%20Detection-9B59B6?style=for-the-badge&logo=artificial-intelligence&logoColor=white)

<!-- Dead Code Detection -->
![Dead Code](https://img.shields.io/badge/Dead%20Code-Detection-E74C3C?style=for-the-badge&logo=code&logoColor=white)
...
### Custom ASCII Badges (For plain markdown)
...
│     95%              │  │   <100ms             │  │   1000+              │
│                      │  │                      │  │                      │
│  Hallucination       │  │  Per file            │  │  Symbols scanned     │
│  detection rate      │  │  validation          │  │  per project         │
└──────────────────────┘  └──────────────────────┘  └──────────────────────┘
...
To use these visual elements in your README.md:

1. **Copy the ASCII art** sections directly into your markdown
2. **Use the badge markdown** for dynamic shields (requires shields.io)
3. **Wrap ASCII art in triple backticks** with `text` or no language specifier
4. **Place the header** at the very top of your README
5. **Use severity indicators** next to issue descriptions
6. **Include the workflow diagram** in your "How It Works" section

All elements are designed to render correctly in:
- GitHub
- GitLab
- Bitbucket
